    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='auth.user')),
                ('package', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='remark_record', to='logistics.package')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notice', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='logistics.shippingnotice')),
            ],
            bases=('logistics.log',),
        ),
        migrations.CreateModel(
